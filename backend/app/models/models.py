...
class Product(Base):
    ...
    # Structured composition fields, added 2026-08-28 - every one of these
    # is entered by staff from verified source material, never
    # auto-generated; a blank value means "information pending
